...
open class SHDoubleInputAlertView: SHInputAlertView {
    ...
    open var secondTextField: SHUITextField = {
    ...
    private var confirmActionWithView: ((_ inputAlertView: SHDoubleInputAlertView) -> Void)?
     ...
     */
    public static func show(title: String?, subTitles: [String?]?, placeholders: [String?]?, regulars: [String?]? = nil, warnTips: [String?]? = nil, inViewController: Bool = false, viewConfiguration: ((_ inputAlertView: SHDoubleInputAlertView) -> Void)?, cancelAction: (() -> Void)?, confirmAction: @escaping ((_ inputAlertView: SHDoubleInputAlertView) -> Void)) {
        let inputAlertView: SHDoubleInputAlertView = SHDoubleInputAlertView()
