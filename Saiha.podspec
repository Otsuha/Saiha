...
Pod::Spec.new do |spec|
  ...
  自己制作的一些通用代码，可以在 iOS 项目中进行使用。
                   DESC

  spec.homepage     = "https://gitee.com/saiha/saiha"
  ...
  spec.author             = { "Saiha" => "grass.usagi@outlook.com" }
  # Or just: spec.author    = "Saiha"
  # spec.authors            = { "Saiha" => "grass.usagi@outlook.com" }
  # spec.social_media_url   = "https://twitter.com/Saiha"
  ...
  spec.source       = { :git => "https://gitee.com/saiha/saiha.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'SHEmptyView' do |ss|
      ss.source_files = 'Saiha/Classes/SHEmptyView/*'
      ss.frameworks = "Foundation", "UIKit"
      ss.dependency 'Saiha/SHFoundation'
      ss.dependency 'Saiha/SHUIKit'
      ss.dependency 'SnapKit'
